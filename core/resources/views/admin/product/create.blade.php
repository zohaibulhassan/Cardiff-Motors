            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">@lang('Brands') <span class="text-danger">*</span></label>
                                <select class="form-control" name="brand" required>
                                    <option value="" selected disabled>@lang('Select one')</option>
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->id }}" @if (old('brand')==$brand->id) selected="selected" @endif>
                                            {{ __($brand->name) }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" id="category">
                                    ...
                                    @foreach ($allCategory as $category)
                                        <option data-subcategories="{{ $category->subcategories }}" value="{{ $category->id }}" @if (old('category_id')==$category->id) selected="selected" @endif>
                                            {{ __($category->name) }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="year" class="form-control" placeholder="e.g. Year">
                            </div>
                        </div>
                    </div>
