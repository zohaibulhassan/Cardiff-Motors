        ...
        <div class="col-lg-12">
            <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="odometer" class="form-control"
                                    placeholder="e.g: Odometer Reading" value="{{ $product->odometer }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="fuel_type" class="form-control" placeholder="e.g: Fuel Type"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="transmission" class="form-control"
                                    placeholder="e.g: Transmission Type" value="{{ $product->transmission }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="year" class="form-control"
                                    placeholder="e.g: Year of Manufacture" value="{{ $product->year }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="body" class="form-control" placeholder="e.g: Body Type"
                                    value="{{ $product->body }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="engine_size" class="form-control" placeholder="e.g: Engine Size"
                                    value="{{ $product->engine_size }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="doors" class="form-control" placeholder="e.g: Number of Doors"
                                    value="{{ $product->doors }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="price" class="form-control" placeholder="e.g: Product Price"
                                    value="{{ $product->price }}" />
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="payment-method-item">
                                    ...
                                    <small class="mt-2 text-facebook">@lang('Supported files'):
                                        <b>@lang('jpeg'), @lang('jpg').</b>
                                        @lang('Image will be resized into '){{ imagePath()['product']['thumb']['size'] }}@lang('px')
                                    </small>
                                </div>
                            </div>
                            <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <div class="image-upload">
                                            <div class="thumb">
                                                ...
                                                <div class="avatar-edit">
                                                    <input type="file" class="profilePicUpload" name="files[]"
                                                        accept=".png, .jpg, .jpeg">
                                                    <label class="bg--success">@lang('Upload Image')</label>
                                                    <small class="mt-2 text-facebook">@lang('Supported files'):
                                                        <b>@lang('jpeg'), @lang('jpg').</b>
                                                        @lang('Image will be resized into '){{ imagePath()['product']['gallery']['size'] }}@lang('px')
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card my-2">
                    ...
                    <div class="card-body">
                        <h4>Specification Cost and Efficiency</h4>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="co2_emissions" class="form-control"
                                        placeholder="e.g: CO2 Emissions" value="{{ $specification->co2_emissions }}" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="combined" class="form-control"
                                        placeholder="e.g: Combined" value="{{ $specification->euro_status }}" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="urban_nonurban" class="form-control"
                                        ...
                                        value="{{ $specification->urban_nonurban }}" />
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="security" class="form-control"
                                    placeholder="e.g: Security Features" value="{{ $specification->security }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="max_torque" class="form-control"
                                    placeholder="e.g: Max Torque" value="{{ $specification->max_torque }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="valve_gear" class="form-control"
                                    placeholder="e.g: Valve Gear" value="{{ $specification->valve_gear }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="cyl_arr" class="form-control"
                                    placeholder="e.g: Cylinder Arrangement" value="{{ $specification->cyl_arr }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="aspiration" class="form-control"
                                    placeholder="e.g: Aspiration" value="{{ $specification->aspiration }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="drive_rear" class="form-control"
                                    placeholder="e.g: Rear Drive" value="{{ $specification->drive_rear }}" />
                            </div>
                            ...
                            <div class="row container">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="max_gross_weight" class="form-control"
                                        ...
                                        value="{{ $specification->max_gross_weight }}" />
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="towing_weight_braked" class="form-control"
                                        ...
                                        value="{{ $specification->towing_weight_braked }}" />
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="towing_weight_unbraked" class="form-control"
                                        ...
                                        value="{{ $specification->towing_weight_unbraked }}" />
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="adult" class="form-control"
                                    placeholder="e.g: Adult Occupancy" value="{{ $specification->adult }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="child" class="form-control"
                                    placeholder="e.g: Child Occupancy" value="{{ $specification->child }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="pedestrian" class="form-control"
                                    placeholder="e.g: Pedestrian Safety" value="{{ $specification->pedestrian }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="safety_assist" class="form-control"
                                    placeholder="e.g: Safety Assist" value="{{ $specification->safety_assist }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="overall" class="form-control"
                                    placeholder="e.g: Overall Safety" value="{{ $specification->overall }}" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="euro_status" class="form-control"
                                    placeholder="e.g: Euro Status" value="{{ $specification->euro_status }}" />
                            </div>
                        </div>
                    </div>
        ...
        (function($) {
            ...
            $('[name=category_id]').on('change', function() {
                ...
                $.each(subcategories, function(i, val) {
                    html += '<option value=' + val.id + ' ' + (val.id == subcategory_id ? 'selected' :
                        '') + '>' + val.name + '</option>';
                });
                console.log(html)
